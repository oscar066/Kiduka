...
import { AlertCircle, CheckCircle, Leaf, Beaker, TrendingUp, Calendar, AlertTriangle } from "lucide-react"
...
export default function SoilFertilityDashboard() {
  ...
  const isFormValid = () => {
    return soilData.simplified_texture && 
           soilData.ph > 0 && 
           soilData.n >= 0 && 
           soilData.p >= 0 && 
           soilData.k >= 0 && 
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="flex items-center justify-center gap-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Soil Fertility Analysis Dashboard</h1>
          </div>
          <p className="text-gray-600">Predict soil fertility status and get personalized fertilizer recommendations</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <Card className="h-fit">
            <CardHeader>
              ...
              <CardDescription>
                Enter your soil analysis data to get fertility predictions and recommendations
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.1"
                        placeholder="45.5"
                        onChange={(e) => handleInputChange("n", Number.parseFloat(e.target.value) || 0)}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.1"
                        placeholder="35.2"
                        onChange={(e) => handleInputChange("p", Number.parseFloat(e.target.value) || 0)}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.1"
                        placeholder="180.0"
                        onChange={(e) => handleInputChange("k", Number.parseFloat(e.target.value) || 0)}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.1"
                        placeholder="1250"
                        onChange={(e) => handleInputChange("ca", Number.parseFloat(e.target.value) || 0)}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.1"
                        placeholder="220"
                        onChange={(e) => handleInputChange("mg", Number.parseFloat(e.target.value) || 0)}
                      />
                    </div>
                  </div>
                </TabsContent>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.1"
                        placeholder="1.8"
                        onChange={(e) => handleInputChange("cu", Number.parseFloat(e.target.value) || 0)}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.1"
                        placeholder="45.0"
                        onChange={(e) => handleInputChange("fe", Number.parseFloat(e.target.value) || 0)}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.1"
                        placeholder="2.2"
                        onChange={(e) => handleInputChange("zn", Number.parseFloat(e.target.value) || 0)}
                      />
                    </div>
                  </div>
                </TabsContent>
              ...
              <Button onClick={handlePredict} className="w-full" disabled={isLoading || !isFormValid()}>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium">Soil Fertility Status:</span>
                    </div>
                    <Badge className={getFertilityStatusColor(results.soil_fertility_status)}>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span>{Math.round(results.soil_fertility_confidence * 100)}%</span>
                    </div>
                    <Progress value={results.soil_fertility_confidence * 100} className="h-2" />
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="outline">{results.fertilizer_recommendation}</Badge>
                    </div>
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span>Recommendation Confidence</span>
                        <span>{Math.round(results.fertilizer_confidence * 100)}%</span>
                      </div>
                      <Progress value={results.fertilizer_confidence * 100} className="h-2" />
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="prose prose-sm max-w-none">
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                      <h4 className="text-blue-900 font-semibold mb-2">Soil Analysis Summary</h4>
