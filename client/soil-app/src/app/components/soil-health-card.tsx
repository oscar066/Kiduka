...
export function SoilHealthCard({ status, confidence, texture, ph }: SoilHealthCardProps) {
  const getStatusIcon = () => {
    ...
    <Card className="bg-gradient-to-br from-green-50 to-amber-50 border-amber-200">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 pt-2">
          ...
          <div className="space-y-1">
            <span className="text-xs text-gray-500 uppercase tracking-wide">pH Level</span>
