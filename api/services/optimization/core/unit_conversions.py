...
QUEFTS_PH_MIN = 4.5
QUEFTS_PH_MAX = 7.0
QUEFTS_SOC_MAX_G_KG = 70.0
QUEFTS_P_OLSEN_MAX_MG_KG = 30.0
QUEFTS_KEX_MAX_MMOL_KG = 30.0
QUEFTS_SOC_MAX_PERCENT = QUEFTS_SOC_MAX_G_KG / 10.0
QUEFTS_K_EXCHANGEABLE_MAX_PPM = QUEFTS_KEX_MAX_MMOL_KG * K_ATOMIC_MASS_MG_PER_MMOL
